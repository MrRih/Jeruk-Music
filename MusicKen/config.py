...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "MusikZamm")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "samalete")
PROJECT_NAME = getenv("PROJECT_NAME", "Zamm Music Project")
OWNER = getenv("OWNER", "@tehmanisangettt")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/MrRih/Jeruk-Music")
